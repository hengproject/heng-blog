...
> 本文整理自 [`hengproject/ML_recall`](https://github.com/hengproject/ML_recall) 中的 [`transformers/deocder.ipynb`](https://github.com/hengproject/ML_recall/blob/main/transformers/deocder.ipynb)、[`Decoder.py`](https://github.com/hengproject/ML_recall/blob/main/transformers/Decoder.py) 和 [`Model.py`](https://github.com/hengproject/ML_recall/blob/main/transformers/Model.py)。Encoder 实现见[上一篇](/blog/transformer-encoder)。
