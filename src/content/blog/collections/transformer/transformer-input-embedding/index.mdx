---
title: Transformer - Transformer 的输入嵌入与位置编码
...
> 本文整理自 [`hengproject/ML_recall`](https://github.com/hengproject/ML_recall) 中的 [`transformers/input_embedding.ipynb`](https://github.com/hengproject/ML_recall/blob/master/transformers/input_embedding.ipynb)，公式来自 [_Attention Is All You Need_](https://arxiv.org/abs/1706.03762)。
